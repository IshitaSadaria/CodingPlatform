...
mongoose.connect('mongodb+srv://codefiddle:sricharan@cluster0.ovkfg.mongodb.net/cf?retryWrites=true&w=majority', {useNewUrlParser:true, useUnifiedTopology: true}).then(()=>{
